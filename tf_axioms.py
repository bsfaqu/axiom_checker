...
class axioms:
    ...
    def R(self, u, v, print_info=True):
        return sstr(self.tf[(u, v)])

    def b1_1(self, u, v, x, print_info=True):
    ...
    def b1_2(self, u, v, x, print_info=True):
    ...
    def b2(self, u, v, w, print_info=True):
    ...
    def b3_1(self, u, v, x, y, print_info=True):
    ...
    def b3_2(self, u, v, x, y, print_info=True):
        cond_0 = x in self.tf[(u, v)]
    ...
    def b5(self, u, v, w, print_info=True):
    ...
    def b6_1(self, u, v, w, print_info=True):
    ...
    def b6_2(self, u, v, w, print_info=True):
    ...
    def b6_3(self, u, v, w, print_info=True):
    ...
    def tr2(self, u, v, w, print_info=True):
    ...
    def j2(self, u, v, x, print_info=True):
    ...
    def t0(self, u, v, w, print_info=True):
    ...
    def t2s(self, u, v, print_info=True):
    ...
    def t2a(self, u, v, print_info=True):
        cond_0 = self.tf[(u, v)] != self.tf[(v, u)]
    ...
    def b4(self, u, v, x, print_info=True):
        cond_0 = x in self.tf[(u, v)]
    ...
    def co0(self, u, v, x, print_info=True):
        cond_0 = x in self.tf[(u, v)]
    ...
    def co1(self, u, v, x, print_info=True):
        cond_0 = self.tf[(u, x)] == {u, x}
        cond_1 = self.tf[(x, v)] == {x, v}
    ...
    def co2(self, u, v, x, y, print_info=True):
        cond_0 = self.tf[(u, x)] == {u, x}
    ...
    def co3(self, u, v, x, y, print_info=True):
    ...
    def p(self, u, v, x, print_info=True):
        cond_0 = x in self.tf[(u, v)]
    ...
    def med(self, u, v, w, print_info=True):
    ...
    def mod(self, u, v, w, print_info=True):
        cond_0 = self.tf[(u, w)] != set() and self.tf[(w, v)] != set()
    ...
    def ta1(self, u, w, v, print_info=True):
    ...
    def ta2(self, u, w, v, print_info=True):
    ...
    def rv(self, u, x, y, v, print_info=True):
        cond_0 = self.tf[(u, x)] == {u, x}
